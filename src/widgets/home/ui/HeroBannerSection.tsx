...
export const HeroBannerSection = () => (
  <section className="relative rounded-2xl overflow-hidden px-8 py-16 md:py-28 mb-12 -mx-4">
    <Image
    ...
    <div className="relative z-10 max-w-xl animate-fade-up ">
      <p className="text-amber-400 font-bold mb-3">Нова колекція 2026</p>
      ...
      <Link
        href="/catalog"
        className="inline-block bg-amber-600 hover:bg-amber-700 transition-colors px-6 py-3 rounded-lg font-bold text-white text-lg  shadow-md shadow-amber-600/30"
      >
        Перейти до каталогу
      </Link>
    </div>
